...
def processTrackQuery(track, mediaType):
    ...
    try:
        ...
        speech = "Riproduco " + track.title + " di " + track.artist + " da " + server + "."
        playlist.append(track)
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + track + " sul tuo Plex."
        return speech, []
...
def processTrackByArtistQuery(track, artist, mediaType):
    ...
    try:
        ...
        speech = "Non sono riuscita a trovare " + track + " di " + artist + " sul tuo Plex."
        return speech, []
...
def processAlbumQuery(album, mediaType):
    try:
        ...
        speech = "Riproduco " + album + " di " + artist + " da " + server + "."
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + album + " sul tuo Plex."
        return speech, []
...
def processAlbumByArtistQuery(album, artist, mediaType):
    try:
        ...
        speech = "Non sono riuscita a trovare " + album + " di " + artist + " sul tuo Plex."
        return speech, []
...
def processArtistQuery(artist, mediaType):
    try:
        ...
        speech = "Riproduco " + artist + " da " + server + "."
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + artist + " sul tuo Plex."
        return speech, []
...
def processPlaylistQuery(playlist_name, mediaType):
    try:
        ...
        speech = "Riproduco playlist " + playlist_name + " da " + server + "."
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + playlist_name + " sul tuo Plex."
        return speech, []
...
def processQueueTrackQuery(track, mediaType):
    ...
    try:
        track, server = parseTrackJson(processQuery(track, mediaType))
        speech = "Aggiunto " + track.title + " di " + track.artist + " alla coda."
        playlist.append(track)
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + track + " sul tuo Plex."
...
def processQueueAlbumQuery(album, mediaType):
    try:
        album, artist, server, playlist = parseAlbumJson(processQuery(album, mediaType))
        speech = "Aggiunto " + album + " di " + artist + " alla coda."
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + album + " sul tuo Plex."
        return speech, []
...
def processQueueArtistQuery(artist, mediaType):
    try:
        artist, server, playlist = parseArtistJson(processQuery(artist, mediaType))
        speech = "Aggiunto " + artist + " alla coda."
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + artist + " sul tuo Plex."
        return speech, []
...
def processQueuePlaylistQuery(playlist_name, mediaType):
    try:
        ...
        speech = "Aggiunta playlist " + playlist_name + " alla coda."
        return speech, playlist
    except:
        speech = "Non sono riuscita a trovare " + playlist_name + " sul tuo Plex."
        return speech, []
